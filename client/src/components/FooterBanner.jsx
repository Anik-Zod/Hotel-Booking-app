...
function FooterBanner() {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-29 xl:px-32 w-full text-sm text-slate-500 bg-white pt-20 ">
      <svg
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            This is Fully functional Booking apps including advance filtering
            directly from database this advance filtering can hendle very large
            database quering too .
          </p>
        </div>
