    ...
    <section className="container py-12 md:py-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
        <div className="space-y-3">
          <div className="inline-flex items-center gap-2 bg-yellow/10 text-yellow px-3 py-1 rounded-full font-bold text-xs uppercase tracking-tighter border border-blue-100">
            <Sparkles size={14} />
            Limited Time Deals
          </div>
          <h2 className="text-3xl font-black text-gray-900 tracking-tight">
            Exclusive <span className="text-yellow">Offers</span>
          </h2>
        ...
        <button
          ...
          className="flex items-center gap-2 group text-yellow font-bold text-sm md:text-base hover:gap-3 transition-all cursor-pointer"
        >
          Explore All Deals{" "}
          <ArrowRight
            size={20}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <motion.div
          ...
          className="lg:col-span-8 relative group overflow-hidden rounded-[40px] h-[450px] md:h-[500px] shadow-2xl shadow-blue-100"
        >
          <img
          ...
          >
            ...
            <motion.div
              variants={fadeSlide}
              className="absolute top-6 left-6 md:top-10 md:left-10 flex gap-3"
            >
              <div className="bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-2 rounded-2xl flex items-center gap-3">
                <Timer size={20} className="text-yellow animate-pulse" />
            ...
            <motion.div
              variants={fadeSlide}
              className="absolute bottom-6 left-6 md:bottom-10 md:left-10 right-6 md:right-10 flex flex-col md:flex-row md:items-end justify-between gap-6"
            >
              <div className="space-y-2">
                <span className="text-yellow font-bold uppercase tracking-widest text-xs">
                  Summer Flash Sale
                </span>
        ...
        >
          ...
          <motion.div
            variants={fadeSlide}
            className="flex-1 bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden group cursor-pointer hover:shadow-2xl transition-all duration-500"
          >
          ...
          <motion.div
            variants={fadeSlide}
            className="flex-1 relative rounded-[35px] px-8 py-5 overflow-hidden group cursor-pointer transition-all duration-500 shadow-xl hover:shadow-rose-200/50"
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex justify-between items-start">
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/10 px-3 py-1 rounded-full">
                  <span className="text-[10px] font-black text-rose-200 uppercase tracking-[0.2em]">
                    Signature
                  </span>
                </div>
              </div>
              ...
              <div>
                <h4 className="text-2xl font-extrabold text-white leading-tight">
                  Honeymoon <br />{" "}
                  <span className="bg-gradient-to-r from-rose-300 to-rose-100 bg-clip-text text-transparent italic serif">
                    Elite Experience
                  </span>
                </h4>
              </div>
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[10px] text-rose-300/50 uppercase font-bold tracking-widest">
                    Starting at
                  </span>
