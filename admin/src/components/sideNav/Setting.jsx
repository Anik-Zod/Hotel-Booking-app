...
export default function SettingsSidebar({ showSettings }) {
  return (
      ...
      <AnimatePresence>
        {showSettings && (
          <motion.div
            ...
            initial={{ x: 60, opacity: 0, width: 0 }}
            animate={{ x: 0, opacity: 1, width: 350 }}
            exit={{ x: 60, opacity: 0, width: 0 }}
          ...
          >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="relative">
                  ...
                  <div className="relative size-12 rounded-2xl bg-global border border-primary/20 flex items-center justify-center text-primary shadow-inner">
                    <SettingsIcon size={24} className="animate-[spin_8s_linear_infinite]" />
                  </div>
                </div>
                <div>
            ...
            <div className="flex-1 overflow-y-auto px-4 space-y-2 custom-scrollbar">
              <p className="px-3 pb-2 text-[10px] font-black text-textDull/40 uppercase tracking-[0.3em]">General</p>
              ...
              <div className="pt-6 pb-2">
                <p className="px-3 pb-2 text-[10px] font-black text-textDull/40 uppercase tracking-[0.3em]">Danger Zone</p>
                <div className="p-4 rounded-2xl hover:bg-red-500/5 border border-transparent hover:border-red-500/20 group transition-all duration-300 cursor-pointer flex items-center gap-4">
                   ...
                   <div className="flex-1">
                      <h3 className="font-bold text-textColor/60 group-hover:text-red-400 transition-colors">Sign Out</h3>
                      <p className="text-textDull/40 text-[11px] group-hover:text-red-500/60 transition-colors italic">Terminate current session</p>
                   </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-global/50 border-t border-primary/5">
              <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black text-primary uppercase tracking-tighter">System Nominal</span>
                </div>
                <span className="text-[10px] font-medium text-textDull opacity-30">v4.8.0-PRO</span>
              </div>
            </div>
          </motion.div>
        )}
